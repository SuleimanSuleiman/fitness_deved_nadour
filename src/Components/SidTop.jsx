...
const SidTop = () => {
  return (
    <nav className="z-50 flex justify-between items-center w-full rounded-lg shadow-lg sm:px-12 px-4 backdrop-filter backdrop-blur-lg backdrop-saturate-150  fixed top-0">
      <NavLink>
